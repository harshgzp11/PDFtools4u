  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 gap-8">
        <main className="flex-1 bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 min-h-[600px]">
          {children}
        </main>
        
        {/* Sidebar for Ads / Info */}
        <aside className="hidden lg:block w-72 space-y-6">
          <AdSlot orientation="vertical" />
          <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
            <h3 className="font-semibold text-blue-900 flex items-center gap-2 mb-2">
              <Shield className="w-5 h-5" /> 100% Private
            </h3>
            <p className="text-sm text-blue-800">
              Your files never leave your device. All processing is done locally in your browser for maximum security.
            </p>
          </div>
        </aside>
      </div>
