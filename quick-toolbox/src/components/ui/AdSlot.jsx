...
export default function AdSlot({ orientation = "horizontal", className = "" }) {
  ...
  return (
    <div className={`bg-gray-100 border border-gray-200 rounded-lg flex items-center justify-center overflow-hidden relative ${isHorizontal ? 'w-full h-24' : 'w-64 h-full min-h-[300px]'} ${className}`}>
