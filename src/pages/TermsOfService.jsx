        ...
        <div className="prose prose-gray max-w-none space-y-8 text-sm sm:text-base leading-relaxed text-gray-600">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Service Modifications:</strong> We reserve the right to modify, suspend, temporarily disable, or permanently discontinue any part of the website or tools at any time without prior notice or liability.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Process files that violate copyright laws, trademarks, trade secrets, or the privacy rights of any third party without explicit permission or legal authorization.</li>
              <li>Attempt to bypass, disable, reverse-engineer, or tamper with any security features or system architecture of the website.</li>
              <li>Use automated scripts, bots, spiders, or scrapers to access the site in a manner that creates an unreasonable load on our infrastructure or degrades performance for other users.</li>
              <li>Upload, process, or transmit files containing malware, viruses, trojans, ransomware, or any malicious code designed to interfere with the functionality of software or hardware.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Guarantees that the tools will be uninterrupted, error-free, completely secure, or free of bugs or glitches.</li>
              <li>Guarantees regarding the accuracy, completeness, layout fidelity, or formatting retention of converted, merged, or edited documents.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Document corruption, conversion inaccuracies, or file deletion.</li>
              <li>Business interruption or loss of business opportunity resulting from your use of or inability to use the Services.</li>
              <li>Any unauthorized access to or alteration of your transmissions or data occurring on your local device or network.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Your use or misuse of the tools and website.</li>
              <li>Any claim that a file processed by you violates the copyright, trademark, or intellectual property rights of a third party.</li>
            </ul>
          </section>
          ...
          <section className="bg-gray-50 border border-gray-200/80 rounded-xl p-6">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">12. Contact Information</h2>
            <p className="mb-4">
